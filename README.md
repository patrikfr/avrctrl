...
`java -jar target/avr-ctrl-0.9.1.jar --help`
...
The default network name for the receiver is `denon-avr-x2100w.local` this can be overridden with a new name or IP
...
`native-image --no-server --no-fallback -jar target/avr-ctrl-0.9.1.jar avrctrl`
